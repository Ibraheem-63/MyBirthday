      ...
      <div className="w-[400px] h-screen flex flex-col items-center justify-center">
        <motion.div initial={{ opacity: 0, visibility: "hidden" }}
          ...
          <div id="card" className={`${cardClass}`} onClick={toggleCard}>
            <div id="card-inside">
              <div className="wrap">
                <p>Happy Birthday, Amidat!</p>
            <p>May your birthday be just the beginning of a year filled with 
              happy memories, wonderful moments, and shining dreams. 💖✨</p>
            <p>
            May Allah bless you with health, happiness, and barakah in your life. Ameen. 🎉
            </p>
            <p>
            Bon, c'est tout pour le moment ! Profite bien de ta journée spéciale, mais n'oublie pas… garde mon gâteau en sécurité et intact,
             sinon il y aura des conséquences royales 👑🎂.
            </p>
            <p className="signed">Mr Fatiu </p>
          </div>
        </div>
